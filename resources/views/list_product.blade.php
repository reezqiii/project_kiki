...
<body>
    ...
    <form class="max-w-xs mx-auto " method="POST" action="{{ route('produk.simpan') }}">
        ...
        <form class="max-w-sm mx-auto">
            <div class="mb-5">
                <label for="nama" class="block mb-2 mt-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                    Produk</label>
            ...
            <div class="mb-5">
                <label for="Deskripsi" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Deskripsi
                    Produk</label>
                <textarea type="deskripsi" id="deskripsi" name="deskripsi"
            ...
            <div class="mb-5">
                ...
                <input type="number" id="harga" name="harga"
                    class=" form-control shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-ublue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                     required />
            </div>
            <button type="submit"
                class="text-white mb-5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Simpan</button>
        </form>
        </div>
</body>
